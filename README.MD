...
Como vemos na imagem, quem executou a requisição foi nó `fastapi1` que tem o seguinte endereço IP: `172.20.0.5`.

O servidor onde a aplicação está sendo executada é o Nginx, onde está marcado pelo o retângulo.
